...
curl http://${target}/index.php \
  ...
  sed -i "s|0 => '172.17.0.1:22000'|0 => '"${DOMAIN}"'|g" ./config/config.php
  sed -i "s|'overwrite.cli.url' => 'https://172.17.0.1:22000'|'overwrite.cli.url' => 'https://"${DOMAIN}"'|g" ./config/config.php
